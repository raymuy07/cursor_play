...
-- Comprehensive schema for jobs.db with normalization and indexing
...
-- Insert canonical departments thats just ai guessing. it needs to be done through logging.
...
UNION ALL
SELECT 'Remote', id FROM locations WHERE canonical_name = 'Remote'
UNION ALL
SELECT 'Work from Home', id FROM locations WHERE canonical_name = 'Remote'
UNION ALL
SELECT 'WFH', id FROM locations WHERE canonical_name = 'Remote';
